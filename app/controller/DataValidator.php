...
class DataValidator {
    ...
    protected function set_messages_default(){
        $this->_messages = array(
            ...
            'is_email'       => '<span class="help is-danger ">O email %s não é válido </span><br>',
            'email_no_found' => '<span class="help is-danger ">O email ou senha inválida </span><br>',
    ...
    public function no_found(){
        if (empty ($this->_data['value'])){
            $this->set_error(sprintf($this->_messages['email_no_found'], $this->_data['name']));
        }
        return $this;
    }
